...
export class AuthController {
    ...
    @HttpCode(HttpStatus.OK)
    @Post("vk-user")
    async getVk(@Body() dto: getVKUser){
		
     return this.authService.fetchVK(dto).catch((e)=>{
		 throw e;
	 })
    ...
    async getYandex(@Body() dto: getVKUser){
     ...
     return this.authService.fetchYandex(dto).catch((e)=>{
		 throw e;
	 })
  
    }
    
// vi /root/chatroulette/chatroulette/src/auth/auth.controller.ts
